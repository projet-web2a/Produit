...
<html>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Categorie</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
    
       
	<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark"><a class="navbar-brand" href="categorie_ajout.html">    Ajouter</a>
  ...
  <thead>
    <tr>
      <th scope="col">Reference Categorie</th>
...
<?php foreach($listecategorie as $categorie): ?>
    <tr>
      <td> <?= $categorie->refp ; ?> </td>
	  <td> <?= $categorie->nom ; ?> </td>
     
	  
    <td>
              <a href="modifier_categorie.php?refp=<?= $categorie->refp ?> "   class="btn btn-info"> Edit </a>
              <a onclick="return confirm('Are you sure you want to delete this entry ?')" href="supprimerCategorie.php?refp=<?= $categorie->refp ?>" class="btn btn-danger"> Delete </a>
            </td> 
    </tr>
  </tbody>
            <?php endforeach; ?>
