...
require 'C:/wamp64/www/Projet2eme/entites/categorie.php';
require 'C:/wamp64/www/Projet2eme/core/catergorieC.php';
$refp=$_GET['refp'];
$categorieC=new categorieC();
$result=$categorieC->recuperercategorie($refp);
...
<html>
  <head>
    ...
    <title>EyeZone | categories</title>
...
<script language="javascript" src="js/javafront.js" ></script>
 ...
 <form name="f" method="POST">
  <div class="form-group">
    <label for="formGroupExampleInput">Référence Categorie</label>
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="reference categorie" name="inputrefp" value="<?PHP echo $refp ?>" readonly>
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput2">Marque</label>
    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Marque" name="inputnom" value="<?PHP echo $nom ?>">
  </div>
  ...
  <button type="submit" class="btn btn-primary" name="modifier" ">Modifier</button>
	...
	<?php
	 $Refp=$_POST['inputrefp'];
 	$Nom=$_POST['inputnom'];
 	
	if ( isset($_POST['modifier']))
{
 if (ctype_alpha($_POST['inputnom'])==true){
 
  $categorie = new categorie($Refp,$Nom);
  $cat= new categorieC();
  $cat->modifiercategorie($categorie,$refp);
echo "<script type='text/javascript'>";
echo "alert('Modifier avec success!');
window.location.href='../admin/categorie_v.php';";
	echo "</script>";
}
else {echo "<script type='text/javascript'>";
echo "alert('Marque needs to be only letters!');
	echo "</script>";}
}
?>
  </body>
